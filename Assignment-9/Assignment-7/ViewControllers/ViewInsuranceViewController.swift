...
class InsuranceCardView: UIView {
    ...
    init(insurance: Insurance, action: @escaping ((Int)->())) {
        ...
        policyIDLabel.text = "Policy ID: \(insurance.id)"
    ...
    private func setupUI() {
        policyIDLabel.translatesAutoresizingMaskIntoConstraints = false
        ...
        let stackView = UIStackView(arrangedSubviews: [policyIDLabel,policyTypeLabel, premiumLabel, startDateLabel, endDateLabel])
